...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY ="BRnY252R553mJjYZFF120MQru1fof8f1LjUEsmA6";
    private static final String SECRETKEY ="109Fl6qo_qTGlKR_bwOjSHXdN8YGswIPu3GqwkSe";
    // 对象仓库
    private static final String BUCKET = "chaokeai";
    public static final String DOMAIN= "http://qvrhvbmc7.hd-bkt.clouddn.com/";
